# Spec: AWS Infrastructure — Migrations

## Purpose

Defines the Alembic migration strategy for cloud environments: one-off ECS task, CI orchestration, and separation from app startup.
