...
Defines the async database engine configuration, ORM base model conventions, core data models (bicycles, users, rentals), and migration strategy using Alembic.
