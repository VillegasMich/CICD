# Spec: Terraform Module Structure

## Purpose

Defines the modular Terraform directory layout, remote state backend configuration, module output contracts, and secret injection strategy.
